...
class StateProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state_project" do
    assert_difference("StateProject.count") do
      post state_projects_url, params: { state_project: { Project_id: @state_project.Project_id, State_id: @state_project.State_id, fecha_transicion: @state_project.fecha_transicion } }
    end
  ...
  test "should update state_project" do
    patch state_project_url(@state_project), params: { state_project: { Project_id: @state_project.Project_id, State_id: @state_project.State_id, fecha_transicion: @state_project.fecha_transicion } }
